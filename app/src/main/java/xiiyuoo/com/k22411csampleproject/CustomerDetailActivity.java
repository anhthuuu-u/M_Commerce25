...
public class CustomerDetailActivity extends AppCompatActivity {
    ...
    {
        //Lấy dữ liệu trên giao diện và mô hình hóa lại hướng đói tượng Customer
        ...
        //đóng dấu là sẽ gửi hàng này đi:
        setResult(500,intent);
        //đóng mn hình này lại, để màn hình gọi nó nhận được kết quả
        finish();
